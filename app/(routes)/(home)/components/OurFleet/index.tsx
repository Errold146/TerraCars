...
export function OurFleet() {
    ...
    return (
        <div className="max-w-6xl mx-auto text-center py-8 lg:py-10 p-6">
            ...
            <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-w-2xl mb-5 lg:mb-10">
                Don't deny yourself of driving the best premium cars from around the word here and now the world.
            </p>
